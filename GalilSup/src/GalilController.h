...
#define GalilTimeString	  	"GALIL_TIME"
#define GalilSyncTimeString	  	"GALIL_SYNC_TIME"
...
private:
  ...
  bool try_async_;              // where to try async (DR) for data record - if not, will just go straight to polling/sync (QR)   
